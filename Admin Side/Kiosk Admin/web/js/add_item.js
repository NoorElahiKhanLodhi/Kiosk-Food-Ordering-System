///get Category
var param = location.search.split('category=')[1];

if(location.search.split('category=')[1].substring("%20")){
var cat_new = param.replace("%20"," ");
document.getElementById("category").value = cat_new;
console.log(cat_new);
}
